...
var FormInput = function (_Component) {
  ...
  function FormInput(props) {
    ...
    _this.formInputRef = _react2.default.createRef();
    return _this;
  }
  ...
  _createClass(FormInput, [{
    ...
    value: function getValue() {
      return 'value' in this.formInputRef.current ? this.formInputRef.current["value"] : this.formInputRef.current.getValue();
    }
  }, {
    key: 'render',
...
exports.default = (0, _react.forwardRef)(FormInput);